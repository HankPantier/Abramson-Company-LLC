---
title: "Who We Are | Abramson & Company LLC"
url: "/who-we-are"
...
hero_image: "westport-ct-cpa-team-office.jpg"
hero_image_alt: "CPA team members reviewing financial documents together in a Westport Connecticut office"
...
Ray founded Abramson & Company in its current form in 2005, and the firm has operated out of Westport, CT, ever since. Two decades in one town builds a certain kind of institutional memory: we've worked with clients through market downturns, business sales, generational transitions, and every tax law change in between.

Longevity matters when you're choosing someone to handle your finances. A firm that's been advising the same community since 2005 has already made its mistakes, refined its processes, and built the systems that let it respond quickly when a client calls with a problem. That history is part of what clients are buying when they sign on with us, not just a set of services but a firm that's still standing and still local.

<!-- block: content-split | variant: image-left | image: team-collaboration-client-file.jpg | alt: "Two CPA team members reviewing a client account together at a desk" | query: "accounting team collaborating office desk" -->
## A team that knows you, not just your file

One of the most common complaints about accounting firms is the single point of failure: your main contact goes on vacation, changes roles, or leaves, and suddenly nobody can answer a simple question. We built our team culture to avoid that problem entirely.

Multiple people on our staff know each client's business, not just their file number. If your usual contact is out, someone else can pick up the phone and already understand your entity structure, your payroll schedule, or where your tax return stands. It's a small operational choice with a big effect on how supported clients feel, especially during tax season or a business transition when timing matters most.

<!-- block: checklist-section | variant: with-image | image: westport-fairfield-county-map-area.jpg | alt: "Map view of Westport and Fairfield County Connecticut coastline" | query: "connecticut coastal town aerial view" -->
## Serving Westport, Fairfield County, and beyond

Our home base is Westport, CT, and most of our client relationships start close to home. But the firm's reach extends well past the town line, following clients as their businesses and lives grow.

- Westport, CT and the surrounding Fairfield County towns
- The tri-state area spanning Connecticut, New York, and New Jersey
- Clients in California, with a concentration in the Bay Area
- Remote collaboration for clients who split time between coasts
...
How we work matters as much as what we do. Three things set the day-to-day experience apart from a typical CPA relationship.

### Bundled services, one fixed fee
icon: DollarSign

Bookkeeping, payroll, tax, and advisory support are bundled under a fixed monthly fee, so clients know their cost before the year starts instead of guessing at an hourly bill.

### A secure platform for real-time collaboration
icon: ShieldCheck

Documents, financials, and messages move through a secure online platform, so clients can see where things stand and reach their team without waiting for a callback.

### Personalized tax strategies
icon: Target

Tax plans are built around each client's actual entity structure and income sources, not a generic checklist applied to every return.

### CPA-led expertise across every service
icon: BadgeCheck

Every engagement, from [bookkeeping](/services/bookkeeping) to [payroll](/services/payroll) to [business advisory work](/services/business-management-services), is overseen by CPA-led staff rather than handed off to junior processors. See the [full service list](/services) for details, or read what current clients say on our [testimonials page](/testimonials).
...
You don't need a fully organized spreadsheet or a list of tax questions to reach out. Most client relationships start with a conversation about what isn't working, whether that's a bookkeeping backlog, a confusing tax bill, or a business decision that needs a second opinion from someone who knows the numbers.

[Schedule a consultation](/contact) and talk with the Westport, CT team that's been doing this since 2005.
...
**E-E-A-T Signals:**
- Firm founded in 2005 by Ray, operating continuously in Westport, CT for two decades
...
- business advisory work → /services/business-management-services — Links CPA-led expertise claim to the relevant advisory service page
- testimonials page → /testimonials — Builds trust by directing readers to client reviews after describing the firm's approach
  ...
  "itemListElement": [
    {
      ...
      "position": 1,
      "name": "Who We Are",
      "item": "https://www.abramsonco.com/who-we-are"
    }
  ]
}
</script>
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Abramson & Company is based in Westport, CT, and serves clients throughout Fairfield County, the tri-state area of Connecticut, New York, and New Jersey, and California, with a concentration of clients in the Bay Area."
      }
    },
    {
      "@type": "Question",
      "name": "Who founded Abramson & Company?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Ray founded Abramson & Company in its current form in 2005. The firm has operated continuously in Westport, CT since then, building long-term relationships with small business owners and individuals across Fairfield County."
      }
    },
    {
      "@type": "Question",
      "name": "What types of clients does Abramson & Company work with?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The firm's ideal clients include small business owners, real estate professionals, professional service providers, retail businesses, and not-for-profit organizations, along with niche clients in equine and influencer businesses."
      }
    },
    {
      "@type": "Question",
      "name": "What makes Abramson & Company different from other CPA firms?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Abramson & Company bundles bookkeeping, payroll, tax, and advisory services under one fixed monthly fee, gives clients access to a secure online platform for real-time collaboration, and staffs each account with multiple team members familiar with the client's file."
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Who We Are | Westport, CT CPA Firm Since 2005",
  "url": "https://www.abramsonco.com/who-we-are",
  "description": "Meet the Westport, CT CPA firm behind Abramson & Company. Founded in 2005, we bundle bookkeeping, tax, payroll, and advisory into one fixed-fee, personal service.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "Abramson & Company LLC",
    "url": "https://www.abramsonco.com"
